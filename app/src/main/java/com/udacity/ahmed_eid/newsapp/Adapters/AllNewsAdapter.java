...
public class AllNewsAdapter extends RecyclerView.Adapter<AllNewsAdapter.allNewsViewHolder> {
    ...
    public AllNewsAdapter(Context mContext, ArrayList<News> news) {
    ...
    public allNewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        myView = LayoutInflater.from(mContext)
                .inflate(R.layout.item_all_news, parent, false);
        return new allNewsViewHolder(myView);
    }
    ...
    public class allNewsViewHolder extends RecyclerView.ViewHolder {
        ...
        public allNewsViewHolder(View itemView) {
            super(itemView);
            nImage = itemView.findViewById(R.id.all_news_image);
            nTitle = itemView.findViewById(R.id.all_news_title);
            layout = itemView.findViewById(R.id.all_news_article_layout);
        }
    }
}
